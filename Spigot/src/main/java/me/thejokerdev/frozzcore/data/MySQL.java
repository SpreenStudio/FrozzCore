...
public class MySQL extends Data {
    ...
    private void setupConnection() throws SQLException {
        ...
        try {
            ...
            var3.executeUpdate(String.format("CREATE TABLE IF NOT EXISTS `%s` (`id` INT NOT NULL AUTO_INCREMENT, `username` VARCHAR(32) NOT NULL UNIQUE, `uuid` varchar(40) UNIQUE, `lang` TEXT, `firstJoin` BOOLEAN, `hype` INT(12) DEFAULT '0', `visibility` TEXT, `money` DOUBLE(20,2) NOT NULL DEFAULT '0', PRIMARY KEY (id), KEY `fudata_username_idx` (`username`(32))) ENGINE=InnoDB;", this.TABLE_DATA));
            ...
            this.addColumn(this.TABLE_DATA, "money", "DOUBLE(20,2)", "visibility");
            var3.close();
