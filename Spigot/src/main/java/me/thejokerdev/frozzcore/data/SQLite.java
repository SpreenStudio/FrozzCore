...
public class SQLite extends Data {
    ...
    public void setup() {
        ...
        try {
            ...
            var1.executeUpdate(String.format("CREATE TABLE IF NOT EXISTS '%s' ('id' INTEGER PRIMARY KEY, 'uuid' TEXT(40), 'username' TEXT(32), 'lang' TEXT, 'firstJoin' BOOLEAN DEFAULT TRUE, 'hype' INT(12) DEFAULT '0', 'visibility' TEXT, 'money' DOUBLE(20,2) NOT NULL DEFAULT '0'); CREATE INDEX IF NOT EXISTS fudata_username_idx ON %s(username); CREATE INDEX IF NOT EXISTS fudata_uuid ON %s(uuid);", this.TABLE_DATA, this.TABLE_DATA, this.TABLE_DATA));
            ...
            this.addColumn(this.TABLE_DATA, "money", "DOUBLE(20,2)");
            var1.close();
